...
/**
 * Af_dmm_AbstractAction
**/
abstract class Af_dmm_AbstractAction
{
    public /*** XCube_Root ***/ $mRoot = null;

    public /*** Af_dmm_Module ***/ $mModule = null;

    public /*** Af_dmm_AssetManager ***/ $mAsset = null;
    ...
    **/
     ...
     * @param   void
     * 
     * @return  Af_dmm_{Tablename}Handler
    **/
	...
	**/
	...
	{
		$this->mAccessController['main'] = Af_dmm_Utils::getAccessControllerObject($this->mAsset->mDirname, $dataname);
	}
    /**
