 ...
 * tag client delegate
**/
class Af_dmm_TagClientDelegate implements Legacy_iTagClientDelegate
{
    /**
     * getClientList
     *
    ...
    public static function getClientList(/*** mixed[] ***/ &$list, /*** string ***/ $tDirname)
    {
        ...
        foreach($dirnames as $dir){
            ...
            if(Af_dmm_Utils::getModuleConfig($dir, 'tag_dirname')==$tDirname){
                $list[] = array('dirname'=>$dir, 'dataname'=>'lists');
    ...
    public static function getClientData(/*** mixed ***/ &$list, /*** string ***/ $dirname, /*** string ***/ $dataname, /*** int[] ***/ $idList)
    {
        ...
        //setup client module info
        $cri = Af_dmm_Utils::getListCriteria($dirname);
