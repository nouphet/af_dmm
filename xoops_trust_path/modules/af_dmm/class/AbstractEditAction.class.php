...
/**
 * Af_dmm_AbstractEditAction
**/
abstract class Af_dmm_AbstractEditAction extends Af_dmm_AbstractAction
{
    ...
    **/
    public function getDefaultView()
    {
        ...
        return AF_DMM_FRAME_VIEW_INPUT;
    }
    ...
    **/
    public function execute()
    {
        ...
        {
            return AF_DMM_FRAME_VIEW_CANCEL;
        }
    ...
    **/
    ...
    {
        $this->mRoot->mController->executeRedirect($this->_getNextUri($this->_getConst('DATANAME')), 1, _MD_AF_DMM_ERROR_DBUPDATE_FAILED);
    }
