...
require_once AF_DMM_TRUST_PATH . '/class/AbstractAccessController.class.php';

/**
 * Af_dmm_GroupAccessController
**/
class Af_dmm_GroupAccessController extends Af_dmm_AbstractAccessController
{
	public $mType = 'group';
