...
/**
 * Af_dmm_AbstractViewAction
**/
abstract class Af_dmm_AbstractViewAction extends Af_dmm_AbstractAction
{
	...
	**/
	...
	{
		$this->mRoot->mController->executeRedirect($this->_getNextUri($this->_getConst('DATANAME'), 'list'), 1, _MD_AF_DMM_ERROR_CONTENT_IS_NOT_FOUND);
	}
}
