...
require_once AF_DMM_TRUST_PATH . '/class/AbstractListAction.class.php';

/**
 * Af_dmm_ListsListAction
**/
class Af_dmm_ListsListAction extends Af_dmm_AbstractListAction
{
	...
	**/
	public function getDefaultView()
	{
		...
		if(! $this->_getCatId()){
			...
			$idList = $this->mAccessController['main']->getPermittedIdList(Af_dmm_AbstractAccessController::VIEW, $this->_getCatId());
	...
	**/
	...
	{
		$render->setTemplateName($this->mAsset->mDirname . '_lists_list.html');
